...
export default function CrestCertifiedPenetrationTesting() {
 ...
 {/* Hero Section */}
 <section className="py-20 bg-gradient-to-br from-cream via-white to-paleyellow/30 ">
 ...
 <h3 className="text-2xl font-bold text-charcoal mb-4">CREST Approved Testing</h3>
 ...
 <h3 className="text-xl font-semibold text-charcoal mb-4">{test.title}</h3>
 <p className="text-charcoal/70 ">{test.description}</p>
 </div>
 </ScrollAnimation>
 ))}
 </div>

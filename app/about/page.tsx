...
export default function AboutPage() {
 ...
 {/* Hero Section */}
 <section className="pt-20 pb-12 bg-gradient-to-br from-cream via-white to-paleyellow/30 ">
 ...
 <div>
 <h4 className="font-medium text-charcoal mb-1">Client:</h4>
 <p className="text-charcoal/70 ">{study.client}</p>
 </div>
 
 <div>
 <h4 className="font-medium text-charcoal mb-1">Challenge:</h4>
 <p className="text-charcoal/70 ">{study.challenge}</p>
 </div>
 
 <div>
 <h4 className="font-medium text-charcoal mb-1">Solution:</h4>
 <p className="text-charcoal/70 ">{study.solution}</p>
 </div>
 
 <div>
 <h4 className="font-medium text-charcoal mb-1">Results:</h4>
 <p className="text-charcoal/70 ">{study.results}</p>
 </div>
 </div>
 </CardContent>
 </Card>

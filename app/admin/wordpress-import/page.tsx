...
export default function WordPressImportPage() {
 ...
 return (
 <div className="min-h-screen pt-20 pb-20 bg-white/95 ">
 <div className="container max-w-4xl">
 <div className="mb-8">
 <h1 className="text-4xl font-bold text-charcoal mb-4">WordPress Import Tool</h1>
 ...
 <div>
 <Label htmlFor="wordpress-url" className="text-charcoal ">
 WordPress Site URL *
 </Label>
 <Input
 id="wordpress-url"
 ...
 <div>
 <Label htmlFor="api-key" className="text-charcoal ">
 API Key (Optional)
 </Label>
 <Input
 id="api-key"
 ...
 <span className="text-sm text-charcoal ">Importing posts...</span>
 ...
 <div>
 <h4 className="font-semibold text-charcoal mb-2">Before You Start</h4>
 ...
 <div>
 <h4 className="font-semibold text-charcoal mb-2">What Gets Imported</h4>
 <ul className="text-sm text-charcoal/70 space-y-1">
 ...
 <div>
 <h4 className="font-semibold text-charcoal mb-2">Category Mapping</h4>
 ...
 <h4 className="font-semibold text-charcoal line-clamp-1">{post.title}</h4>
 <Badge className="ml-2 flex-shrink-0">{post.category}</Badge>
 </div>
 <p className="text-sm text-charcoal/70 line-clamp-2 mb-2">{post.excerpt}</p>

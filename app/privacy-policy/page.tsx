...
export default function PrivacyPolicyPage() {
 return (
 <div className="min-h-screen bg-gradient-to-br from-cream via-white to-paleyellow/30 ">
 ...
 <ul className="list-disc pl-6 text-charcoal/80 mb-4">
 ...
 <section className="mb-8">
 <h2 className="text-2xl font-bold text-charcoal mb-4">4. Legal Basis for Processing</h2>
 <p className="text-charcoal/80 mb-4">
 ...
 <section className="mb-8">
 <h2 className="text-2xl font-bold text-charcoal mb-4">5. Data Sharing and Disclosure</h2>
 <p className="text-charcoal/80 mb-4">
 ...
 <section className="mb-8">
 <h2 className="text-2xl font-bold text-charcoal mb-4">6. Data Security</h2>
 <p className="text-charcoal/80 mb-4">
 ...
 <section className="mb-8">
 <h2 className="text-2xl font-bold text-charcoal mb-4">8. Your Rights</h2>
 <p className="text-charcoal/80 mb-4">
 ...
 <section className="mb-8">
 <h2 className="text-2xl font-bold text-charcoal mb-4">9. Cookies</h2>
 <p className="text-charcoal/80 mb-4">
 ...
 <section className="mb-8">
 <h2 className="text-2xl font-bold text-charcoal mb-4">12. Changes to This Privacy Policy</h2>
 <p className="text-charcoal/80 mb-4">
 ...
 <section>
 <h2 className="text-2xl font-bold text-charcoal mb-4">14. Supervisory Authority</h2>
 <p className="text-charcoal/80 ">

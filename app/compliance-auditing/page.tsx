                ...
                <Card className="h-full hover:shadow-lg transition-shadow">
                  <CardHeader>
                    ...
                    <div className="bg-gray-50 dark:bg-charcoal/30 p-3 rounded-lg mb-4">
                      ...
                      <p className="text-xs text-charcoal/70 dark:text-white/70">{cert.methodology}</p>
                    </div>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="h-full hover:shadow-lg transition-shadow">
                  <CardHeader>
                    ...
                    <div className="bg-gray-50 dark:bg-charcoal/30 p-3 rounded-lg mb-4">
                      ...
                      <p className="text-xs text-charcoal/70 dark:text-white/70">{service.methodology}</p>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-2">
              ...
              <ScrollAnimation key={index} animation="slide-up" delay={index * 0.05}>
                <Card className="text-center hover:shadow-lg transition-shadow bg-white dark:bg-charcoal/80">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-semibold text-charcoal dark:text-white mb-2">{framework.title}</h3>
                ...
                <ul className="space-y-3">
                  {credentials.map((credential, index) => (
                    <li key={index} className="flex items-center">
                      ...
                      <span className="text-charcoal dark:text-white text-sm">{credential}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <Card className="p-8 bg-gradient-to-br from-brandyellow/10 to-brandyellow/5">
                <div className="grid grid-cols-2 gap-8 text-center">
                  <div>
                    ...
                    <div className="text-sm text-charcoal/70 dark:text-white/70">Certifications Achieved</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-brandyellow mb-2">98%</div>
                    <div className="text-sm text-charcoal/70 dark:text-white/70">First-Time Pass Rate</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-brandyellow mb-2">12</div>
                    <div className="text-sm text-charcoal/70 dark:text-white/70">Months Average Timeline</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-brandyellow mb-2">100%</div>
                    <div className="text-sm text-charcoal/70 dark:text-white/70">Ongoing Support</div>
                  </div>
                </div>
              </Card>
            </ScrollAnimation>

...
export default function InsightsPlatform() {
 ...
 <section
 id="insights"
 className="py-16 bg-gradient-to-br from-brandyellow/10 to-brightyellow/5 backdrop-blur-sm relative"
 >
 <div className="container">
 <ScrollAnimation animation="fade">
 <div className="text-center mb-12">
 <h2 className="text-responsive-4xl md:text-responsive-6xl font-bold text-charcoal mb-6 text-enhanced">
 Real-Time Penetration Testing Platform
 </h2>
 <p className="text-responsive-xl md:text-responsive-2xl text-charcoal/80 max-w-4xl mx-auto leading-relaxed">
 ...
 <div>
 <h3 className="text-responsive-3xl md:text-responsive-4xl font-bold text-charcoal mb-6">
 Enterprise-Grade Security Testing
 </h3>
 <p className="text-responsive-lg text-charcoal/70 mb-8">
 ...
 <div>
 <h4 className="font-semibold text-charcoal mb-2">Live Dashboard</h4>
 ...
 <div>
 <h4 className="font-semibold text-charcoal mb-2">Advanced Analytics</h4>
 <p className="text-sm text-charcoal/70 ">
 ...
 <div>
 <h4 className="font-semibold text-charcoal mb-2">Expert Support</h4>
 <p className="text-sm text-charcoal/70 ">
 ...
 <div>
 <h4 className="font-semibold text-charcoal mb-2">Seamless Integration</h4>
 <p className="text-sm text-charcoal/70 ">
 ...
 asChild
 size="lg"
 className="bg-charcoal hover:bg-charcoal/90 text-white font-semibold group"
 >
 <Link href="/ptaas">
 ...
 <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto">

...
export default function ParticleNetwork() {
  ...
  // Update the particle colors to be more visible by increasing opacity
  const particleColors = [
    "rgba(255, 215, 0, 0.08)", // Increased from 0.03
    "rgba(255, 193, 7, 0.07)", // Increased from 0.025
    "rgba(169, 169, 169, 0.06)", // Increased from 0.02
    "rgba(211, 211, 211, 0.05)", // Increased from 0.015
  ]
  const lineColor = isDark ? "rgba(255, 215, 0, 0.04)" : "rgba(0, 0, 0, 0.03)" // Increased from 0.01/0.008
  const bgColor = isDark ? "#1A1A1A" : "transparent"

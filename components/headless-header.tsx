...
export default function HeadlessHeader() {
  ...
  return (
    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center space-x-1">
          ...
          <HeadlessMenu as="div" className="relative">
            ...
            >
              <HeadlessMenu.Items className="absolute left-0 mt-2 w-96 origin-top-left rounded-xl bg-white dark:bg-charcoal shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none overflow-hidden">
                <div className="p-6">
                          ...
                          <Link
                            ...
                            className={cn(
                              ...
                              active
                                ...
                                : "hover:bg-gray-50 dark:hover:bg-charcoal/50"
                            )}
                          >
                            ...
                            <div className="mt-1 text-sm text-charcoal/70 dark:text-white/70">
                              {service.description}
                            </div>
                          </Link>
                        )}
        ...
        <div className="flex items-center space-x-2">
          ...
          {/* Mobile Menu Button */}
          <button
            className="lg:hidden text-charcoal dark:text-white p-2 rounded-md hover:bg-brandyellow/10 transition-colors"
      ...
      >
        <nav className="lg:hidden absolute top-full left-0 w-full bg-white/95 dark:bg-charcoal/95 backdrop-blur-md shadow-xl border-t border-lightgray dark:border-gray-700">
          <div className="container py-6">
            <div className="flex flex-col space-y-4">
              ...
              <Disclosure>
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-lg font-medium text-left text-charcoal dark:text-white hover:text-brandyellow transition-colors rounded-md hover:bg-brandyellow/10 ui-open:bg-brandyellow/10 ui-open:text-brandyellow">
                      <span>Services</span>
                      ...
                      <Disclosure.Panel className="px-4 pb-2 space-y-2">
                        {services.map((service) => (
                          <Link
                            key={service.name}
                            href={service.href}
                            className="block px-4 py-3 text-base text-charcoal/70 dark:text-white/70 hover:text-brandyellow hover:bg-brandyellow/5 rounded-md transition-colors"
                            onClick={() => setMobileMenuOpen(false)}
                          >
                            {service.name}
                          </Link>

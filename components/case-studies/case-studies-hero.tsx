...
export default function CaseStudiesHero() {
 ...
 {/* Stats */}
 <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8 border-t border-charcoal/20 ">
 ...
 <div className="text-sm text-charcoal/70 font-medium">Organizations Secured</div>
 </div>
 </ScrollAnimation>
 ...
 <div className="text-3xl font-bold text-charcoal ">98%</div>
 <div className="text-sm text-charcoal/70 font-medium">Client Satisfaction</div>
 </div>
 </ScrollAnimation>
 ...
 <div className="text-sm text-charcoal/70 font-medium">Industries Served</div>
 </div>
 </ScrollAnimation>
 </div>
 </div>

...
export default function RelatedCaseStudies({ currentCaseStudyId, industry }: RelatedCaseStudiesProps) {
  ...
  return (
    <section className="py-20 bg-gray-50/95 dark:bg-black/95 backdrop-blur-sm">
      <div className="container">
        <ScrollAnimation animation="fade">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-charcoal dark:text-white mb-4">Related Case Studies</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {caseStudies.map((study, index) => (
            <ScrollAnimation key={study.id} animation="slide-up" delay={0.2 * index}>
              <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 shadow-lg bg-white dark:bg-charcoal/80 h-full overflow-hidden">
                ...
                <CardHeader className="pb-4">
                  ...
                  <h3 className="text-lg font-bold text-charcoal dark:text-white group-hover:text-brandyellow transition-colors line-clamp-2">
                    {study.title}
                  </h3>
                </CardHeader>

                <CardContent className="pt-0">
                  <p className="text-charcoal/70 dark:text-white/70 mb-4 line-clamp-2">{study.excerpt}</p>

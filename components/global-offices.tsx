...
export default function GlobalOffices() {
 ...
 <Card className="bg-white border-none shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
 ...
 <CardTitle className="text-xl text-charcoal ">{office.country}</CardTitle>
 </CardHeader>
 <CardContent className="text-center">
 <div className="flex items-center justify-center mb-2">
 <MapPin className="w-4 h-4 text-brandyellow mr-2" />
 <p className="text-charcoal/70 ">{office.location}</p>
 </div>
 <p className="text-sm text-charcoal/50 bg-brandyellow/10 px-3 py-1 rounded-full inline-block">
 {office.timezone}
 </p>
 </CardContent>
 </Card>

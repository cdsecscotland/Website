...
export default function HeadlessServices() {
 ...
 <Tab.List className="flex space-x-1 rounded-xl bg-charcoal/10 p-1 backdrop-blur-sm">
 ...
 selected
 ? "bg-white text-charcoal shadow-lg transform scale-105"
 ...
 <CardTitle className="text-xl text-charcoal group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-charcoal group-hover:to-charcoal/70 group-hover:bg-clip-text transition-all duration-300">
 {service.title}
 </CardTitle>
 </CardHeader>
 ...
 "border-charcoal/20 hover:shadow-lg",

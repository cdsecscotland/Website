      ...
      <div className="container">
        <ScrollAnimation animation="fade">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-charcoal dark:text-white mb-4">Related Articles</h2>
            ...
            <ScrollAnimation key={post.id} animation="slide-up" delay={0.2 * index}>
              <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 shadow-lg bg-white dark:bg-charcoal/80 h-full overflow-hidden">
                ...
                <CardContent className="pt-0">
                  <p className="text-charcoal/70 dark:text-white/70 mb-4 line-clamp-2">{post.excerpt}</p>

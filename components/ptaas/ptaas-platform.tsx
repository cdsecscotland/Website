...
export default function PTaaSPlatform() {
 return (
 <section id="platform" className="py-20 bg-white/95 backdrop-blur-sm">
 ...
 <div>
 <h3 className="text-3xl font-bold text-charcoal mb-6">Real-Time Security Dashboard</h3>
 ...
 <span className="text-charcoal/80 ">Automated compliance reporting</span>
 </li>
 <li className="flex items-start">
 <div className="w-6 h-6 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 flex items-center justify-center mr-3 mt-1 shadow-md">
 <span className="text-white font-bold text-sm">✓</span>
 ...
 <h3 className="text-3xl font-bold text-charcoal mb-4">Comprehensive Testing Coverage</h3>
 ...
 <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg bg-white h-full relative overflow-hidden">
 ...
 <h4 className="text-xl font-bold text-charcoal mb-3 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-charcoal group-hover:to-charcoal/70 group-hover:bg-clip-text transition-all duration-300">
 {type.title}
 </h4>
 <p className="text-charcoal/70 group-hover:text-charcoal/90 transition-colors duration-300">
 {type.description}
 </p>
 </CardContent>
 </Card>

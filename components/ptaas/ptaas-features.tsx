      ...
      <div className="container">
        <ScrollAnimation animation="fade">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal dark:text-white mb-4">Booking in New Tests</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <ScrollAnimation animation="slide-right" delay={0.2}>
            <div>
              <h3 className="text-3xl font-bold text-charcoal dark:text-white mb-6">On-Demand Testing</h3>
            ...
            <div className="grid grid-cols-2 gap-6">
              <Card className="bg-white dark:bg-charcoal/80 border-none shadow-lg">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-lg text-charcoal dark:text-white">Flexible Scheduling</CardTitle>
                </CardHeader>
              ...
              <Card className="bg-white dark:bg-charcoal/80 border-none shadow-lg">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-lg text-charcoal dark:text-white">Rapid Deployment</CardTitle>
                </CardHeader>
                <CardContent className="text-center">
                  <p className="text-sm text-charcoal/70 dark:text-white/70">
              ...
              <Card className="bg-white dark:bg-charcoal/80 border-none shadow-lg">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-lg text-charcoal dark:text-white">Expert Team</CardTitle>
                </CardHeader>
                <CardContent className="text-center">
                  <p className="text-sm text-charcoal/70 dark:text-white/70">
              ...
              <Card className="bg-white dark:bg-charcoal/80 border-none shadow-lg">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-lg text-charcoal dark:text-white">Quality Assured</CardTitle>
                </CardHeader>
                <CardContent className="text-center">
                  <p className="text-sm text-charcoal/70 dark:text-white/70">

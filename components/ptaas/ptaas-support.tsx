...
export default function PTaaSSupport() {
 ...
 <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-4">Remediation</h2>
 ...
 <div>
 <h3 className="text-3xl font-bold text-charcoal mb-6">Expert Technical Support</h3>
 ...
 <div>
 <h4 className="font-semibold text-charcoal mb-2">Dedicated Technical Resource</h4>
 ...
 <div>
 <h4 className="font-semibold text-charcoal mb-2">Extended Support Period</h4>
 <p className="text-charcoal/70 ">
 ...
 <div>
 <h4 className="font-semibold text-charcoal mb-2">Customised Solutions</h4>
 <p className="text-charcoal/70 ">
 ...
 <CardHeader>
 <CardTitle className="text-xl text-charcoal flex items-center">

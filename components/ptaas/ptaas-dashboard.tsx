...
export default function PTaaSDashboard() {
  return (
    <section id="dashboard" className="py-20 bg-white/95 dark:bg-charcoal/95 backdrop-blur-sm">
      <div className="container">
        <ScrollAnimation animation="fade">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal dark:text-white mb-4">The Dashboard</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <ScrollAnimation animation="slide-right" delay={0.2}>
            <div>
              <h3 className="text-3xl font-bold text-charcoal dark:text-white mb-6">Real-Time Overview Of Findings</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                  <div className="flex items-center">
                    ...
                    <span className="font-semibold text-red-800 dark:text-red-200">Critical Vulnerabilities</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                  <div className="flex items-center">
                    ...
                    <span className="font-semibold text-orange-800 dark:text-orange-200">High Risk</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                  <div className="flex items-center">
                    ...
                    <span className="font-semibold text-yellow-800 dark:text-yellow-200">Medium Risk</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                  <div className="flex items-center">
                    ...
                    <span className="font-semibold text-green-800 dark:text-green-200">Low Risk</span>
                  </div>
        ...
        <ScrollAnimation animation="fade" delay={0.6}>
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-charcoal dark:text-white mb-4">Breakdowns and Recommendations</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <ScrollAnimation animation="slide-up" delay={0.8}>
            <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 shadow-lg bg-white dark:bg-charcoal/80">
              <CardHeader className="pb-4">
                <div className="w-12 h-12 bg-brandyellow/20 rounded-lg flex items-center justify-center mb-4">
                  <BarChart3 className="w-6 h-6 text-charcoal dark:text-brandyellow" />
                </div>
                <CardTitle className="text-xl text-charcoal dark:text-white">Detailed Reports</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <ScrollAnimation animation="slide-up" delay={0.9}>
            <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 shadow-lg bg-white dark:bg-charcoal/80">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl text-charcoal dark:text-white">Progress Tracking</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-charcoal/70 dark:text-white/70">
          ...
          <ScrollAnimation animation="slide-up" delay={1.0}>
            <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 shadow-lg bg-white dark:bg-charcoal/80">
              <CardHeader className="pb-4">
                <div className="w-12 h-12 bg-brandyellow/20 rounded-lg flex items-center justify-center mb-4">
                  <CheckCircle className="w-6 h-6 text-charcoal dark:text-brandyellow" />
                </div>
                <CardTitle className="text-xl text-charcoal dark:text-white">Historical Data</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-charcoal/70 dark:text-white/70">

...
export default function PTaaSHero() {
 ...
 <h1 className="text-responsive-4xl md:text-responsive-5xl lg:text-responsive-6xl font-bold mb-6 leading-tight text-charcoal ">
 ...
 asChild
 size="lg"
 className="bg-charcoal hover:bg-charcoal/90 text-white font-semibold px-8 py-4 text-lg shadow-xl"
 >
 ...
 size="lg"
 variant="outline"
 className="border-2 border-charcoal text-charcoal hover:bg-charcoal hover:text-white font-semibold px-8 py-4 text-lg"
 >
 ...
 <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pt-8 border-t border-charcoal/20 ">
 <div className="text-center">
 ...
 <div className="text-responsive-lg font-bold text-charcoal ">Real-Time</div>
 <div className="text-responsive-sm text-charcoal/70 font-medium">
 ...
 <div className="text-responsive-lg font-bold text-charcoal ">Immediate</div>
 <div className="text-responsive-sm text-charcoal/70 font-medium">
 Critical Alerts
 </div>
 </div>
 ...
 <div className="text-responsive-lg font-bold text-charcoal ">Direct Access</div>
 <div className="text-responsive-sm text-charcoal/70 font-medium">
 To Expert Testers
 </div>
 </div>
 ...
 <div className="text-responsive-lg font-bold text-charcoal ">In-House</div>
 <div className="text-responsive-sm text-charcoal/70 font-medium">

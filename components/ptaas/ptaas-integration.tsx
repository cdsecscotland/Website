    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-20">
        <ScrollAnimation animation="slide-right" delay={0.6}>
          <div>
            <h3 className="text-3xl font-bold text-charcoal dark:text-white mb-6">Detailed Vulnerability Analysis</h3>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-charcoal/80 dark:text-white/80">Step-by-step remediation guidance</span>
              </li>
              <li className="flex items-start">
                <div className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center mr-3 mt-1 shadow-md">
                  <span className="text-white font-bold text-sm">✓</span>
                </div>
                <span className="text-charcoal/80 dark:text-white/80">Evidence and proof-of-concept documentation</span>
              </li>
            </ul>
          </div>
        </ScrollAnimation>
      ...
      <div className="text-center mt-20">
        <ScrollAnimation animation="fade" delay={1.0}>
          <h3 className="text-3xl font-bold text-charcoal dark:text-white mb-6">Access Anywhere, Anytime</h3>
          <p className="text-lg text-charcoal/70 dark:text-white/70 max-w-2xl mx-auto mb-12">

...
export default function PTaaSTestimonials() {
 ...
 <p className="text-xl md:text-2xl text-charcoal/90 italic mb-6 leading-relaxed">
 ...
 index === currentTestimonial ? "bg-brandyellow" : "bg-charcoal/20 "
 }`}
 ...
 variant="outline"
 size="icon"
 className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white border-none shadow-lg hover:bg-brandyellow/20"
 ...
 variant="outline"
 size="icon"
 className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-white border-none shadow-lg hover:bg-brandyellow/20"
